...
class ExamScheduler:
    ...
    def load_data(self):
        ...
        try:
            self.classrooms = pd.read_csv(os.path.join(self.data_folder, r"D:\classrooms.csv"))
            self.courses = pd.read_csv(os.path.join(self.data_folder, r"D:\courses.csv"))
            self.instructors = pd.read_csv(os.path.join(self.data_folder, r"D:\instructors.csv"))
            self.schedule = pd.read_csv(os.path.join(self.data_folder, r"D:\schedule.csv"))
            self.students = pd.read_csv(os.path.join(self.data_folder, r"D:\students.csv"))
            self.timeslots = pd.read_csv(os.path.join(self.data_folder, r"D:\timeslots.csv"))
    ...
    def run(self):
        ...
        if len(big_rooms) == 0:
            print(" Warning: No large classrooms (capacity ≥ 100) in data")
